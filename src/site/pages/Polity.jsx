                  ...
                  <main className="questions section-separation">
                        ...
                        <div 
                              ...
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>1.</span> Información personal que recompilamos</h3>
                              </header>
                              <div 
                                    className='question__information'>
                        ...
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>2.</span> ¿Cómo recopilamos la información?</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <div className="question__item">
                                          ...
                                          <div className="question__text">
                                                ...
                                                <ul>
                                                      ...
                                                      <li>_shopify_visit, sin datos retenidos, Persistente durante 30 minutos desde la última visita, Utilizado por el rastreador de estadísticas internas de nuestro proveedor de sitios web para registrar el número de visitas</li>
                                    ...
                                    <div className="question__item">
                                          ...
                                          <p>Los "Archivos de registro" rastrean las acciones que ocurren en el Sitio y recopilan datos, incluyendo su dirección IP, tipo de navegador, proveedor de servicio de Internet, páginas de referencia/salida y marcas de fecha/horario.</p>
                                    </div>
                                    <div className="question__item">
                                          <h3 className="heading__tertiary">3. Balizas web</h3>
                                          <p>Las "balizas web", las "etiquetas" y los "píxeles" son archivos electrónicos utilizados para registrar información sobre cómo navega usted por el Sitio.</p>
                                    </div>
                                    <div className="question__item">
                                          <h3 className="heading__tertiary">4. Extras</h3>
                                          <p>Además, cuando hace una compra o intenta hacer una compra a través del Sitio, recopilamos cierta información de usted, entre la que se incluye su nombre, dirección de facturación, dirección de envío, información de pago (incluidos los números de la tarjeta de crédito, dirección de correo electrónico y número de teléfono. Nos referimos a esta información como "Información del pedido".</p> <br />

                                          <p>Cuando hablamos de "Información personal" en la presente Política de privacidad, nos referimos tanto a la Información del dispositivo como a la Información del pedido.</p> <br />

                                          <p>Recopilamos sus datos también una vez que los inserta en "contacto" para comunicarnos con usted, hacer uso de mailing, campaÑas de sms, o cualquier otro medio de marketing o remarketing en la que usted acepte en recibir información de voztotal.</p>
                                    </div>
                              </div>
                        </div>
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>3.</span> ¿Cómo utilizamos su información personal?</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                                          Usamos la Información del pedido que recopilamos en general para preparar los pedidos realizados a través del Sitio (incluido el procesamiento de su información de pago, la organización de los envíos y la entrega de facturas y/o confirmaciones de pedido). Además, utilizamos esta Información del pedido para: comunicarnos con usted; examinar nuestros pedidos en busca de fraudes o riesgos potenciales; y cuando de acuerdo con las preferencias que usted compartió con nosotros, le proporcionamos información o publicidad relacionada con nuestros productos o servicios.
                                    </p> <br />
                                    <p>                        
                        ...
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>4.</span> Compartir su información personal</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                                          Compartimos su Información personal con terceros para que nos ayuden a utilizar su Información personal, tal como se describió anteriormente. Por ejemplo, utilizamos la tecnología de Shopify en nuestra tienda online. Puede obtener más información sobre cómo Shopify utiliza su Información personal aquí: <a href='https://www.shopify.com/legal/privacy'>https://www.shopify.com/legal/privacy.</a> También utilizamos Google Analytics para ayudarnos a comprender cómo usan nuestros clientes el Sitio. Puede obtener más información sobre cómo Google utiliza su Información personal aquí: <a href='https://www.google.com/intl/es/policies/privacy/'>https://www.google.com/intl/es/policies/privacy/</a>. Puede darse de baja de Google Analytics aquí: <a href='https://tools.google.com/dlpage/gaoptout'>https://tools.google.com/dlpage/gaoptout</a>.
                                    </p> <br />
                                    <p>                        
                        ...
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>5.</span> Publicidad orientada por el comportamiento</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                                    Como se describió anteriormente, utilizamos su Información personal para proporcionarle anuncios publicitarios dirigidos o comunicaciones de marketing que creemos que pueden ser de su interés. Para más información sobre cómo funciona la publicidad dirigida, puede visitar la página educativa de la Iniciativa Publicitaria en la Red ("NAI" por sus siglas en inglés) en https://www.networkadvertising.org/understanding-online-advertising/how-does-it-work.
                                    </p> <br />
                                    <p>                        
                                    ...
                                    <p>Además, puede darse de baja de algunos de estos servicios visitando el portal de exclusión voluntaria de Digital Advertising Alliance en: <a href='mailto: https://optout.aboutads.info/'>https://optout.aboutads.info/</a>.</p>
                              </div>
                        </div>
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>6.</span> No rastrear</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                        ...
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>7.</span> Retención de datos</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                        ...
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>8.</span> Menores</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                        ...
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>9.</span> Cambios</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                        ...
                        <div 
                              className="question">
                              <header className="question__header">
                                    <h3 className='heading__secondary'><span>10.</span> Contáctenos</h3>
                              </header>
                              <div 
                                    className='question__information'>
                                    <p>
                                          Para obtener más información sobre nuestras prácticas de privacidad, si tiene alguna pregunta o si desea presentar una queja, contáctenos por correo electrónico a contacto@voztotal.mx o por correo mediante el uso de la información que se proporciona a continuación:

                                          <address>Boulevard de Los Gobernadores, Monte Blanco II, Querétaro, QRO, 76087, México</address>
                                    </p> 
                              </div>
                        </div>
